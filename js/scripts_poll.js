...
var get_results_dance
    ...
    $('#status_decline').click(function(){
        $('#status').val('Decline')
        dancer_response = "decline";
    });
    $('#vote_best_dancer').click(function(){
        $('#dancer_status').val('Voted_Best_Dancer');
        dancer_response = "voted";
    });
    $('#vote_best_dress').click(function(){
...
//        }
    ...
    /********************** Best_Dress **********************/
    $('#dress_form').on('submit', function (e) {
        e.preventDefault();
        //console.log($(this));
        var data = $(this).serialize();
        console.log(data);
        $('#alert-wrapper').html(alert_markup('info', '<strong>Just a sec!</strong> We are saving your details.'));
          $.post('https://script.google.com/macros/s/AKfycbyY5MOh7coMsDiQgZQEYodNWXam6SF3ZZT494C8xai6GlHynBXl8GbgRiQ5sX5Su2IF/exec', data)
              .done(function (data) {
                  ...
                  if (dress_response == "voted" && data.result == "success" ) {
                    $('#alert-wrapper').html('');
                    $('#rsvp-modal').modal('show');
                  }
              })
