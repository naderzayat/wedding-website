...
$(document).ready(function() {
    ...
    var r = createCalendar({
        ...
        data: {
            ...
            address: "Mars",
            description: "We can't wait to see you on our big day. For any queries or issues, please contact 3amak."
        }
    });
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        ...
        $.post("https://script.google.com/macros/s/AKfycbwuJR7o1_X9zxcqcbjXAi1VCWyxQ5lTjMQom6MGbwWqCmisY7U/exec", t).done(function(e) {
